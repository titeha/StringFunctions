...
Сейчас библиотека включает десять основных блоков:
...
> Реализованы все задуманные модули работы с числительными: согласование с числом,
> число прописью (и обратный разбор), склонение по падежам, сумма/валюта прописью,
> порядковые числительные и дата.
