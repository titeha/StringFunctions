...
Сейчас библиотека включает семь основных блоков:
...
> в слова, склонение по падежам и сумма/валюта прописью реализованы. Возможные следующие
> шаги — склонение суммы по падежам.
